...
```
git remote set-url origin https://github.com/Qiu-Weidong/lsbeat
...
```
mkdir -p ${GOPATH}/src/github.com/Qiu-Weidong/lsbeat
git clone https://github.com/Qiu-Weidong/lsbeat ${GOPATH}/src/github.com/Qiu-Weidong/lsbeat
```
